...
*Caption: The stages of drug development, demonstrating how initial drug discovery narrows down thousands of compounds to a single regulatory-approved treatment.*
...
*Caption: Search results from the keyword "acetylcholinesterase". The target protein for this study was acetylcholinesterase in humans (the second entry).*
...
*Caption: Part of the pandas data frame containing the IC50 data for the target protein. Each row is a different molecule (9415 total) that inhibits the target protein. The value column represents the molecule's IC50 value.*
...
*Caption: The sorting of molecules into the appropriate activity classes. A new data column called 'bioactivity_class' was created. Then, each molecule was iterated through, appending the appropriate label to the new column based on the IC50 value.*
...
*Caption: The final dataset composed of 6641 molecules that inhibit AChE. For each molecule, its unique ChEMBL ID, canonical SMILES, IC50 value, and bioactivity class was present.*
...
*Caption: The DataFrame with Lipinski Descriptors added.*
...
*Caption: The effect of the pIC50 conversion on the dataset, scaling the wide-ranging baseline data into a normalized distribution.*
...
*Caption: Frequency Plot of the 2 Bioactivity Classes.*

![pIC50 Box Plot](Figures/CDD_Fig8.png)
*Caption: Box plots of the pIC50 values for the two classes, visually demonstrating the active and inactive ranges.*
...
*Caption: Mann-Whitney U test results indicating LogP differs significantly between active and inactive compounds.*

![Mann-Whitney MW](Figures/CDD_Fig10.png)
*Caption: Molecular weigh had a p value of 4.20 x 10^-73.*

![Mann-Whitney NumHDonors](Figures/CDD_Fig11.png)
*Caption: The number of hydrogen bond donors had a p value of 7.24 x 10^-17.*

![Mann-Whitney NumHAcceptors](Figures/CDD_Fig12.png)
*Caption: The number of hydrogen bond acceptors had a p value of 4.00 x 10^-6.*
...
*Caption: Active molecules in the shaded region in the plot represent the best drug-like inhibitors from the dataset.*
...
*Caption: A view into how the PubChem fingerprint looks.*
...
*Caption: Comparison of model performance based on R-Squared metrics.*

![Model RMSE Comparison](Figures/CDD_Fig16.png)
*Caption: Comparison of model performance based on RMSE values.*

![Model Time Comparison](Figures/CDD_Fig17.png)
*Caption: Comparison of model calculation time.*

![Top 5 Models Table](Figures/CDD_Fig18.png)
*Caption: The scores of the top 5 models. The top 2 have the same R-Squared values, but XGBRegressor is much faster.*
...
*Caption: Visualizes how well the model's predictions align with true experimental results.*
